...
final AndroidConsoleSocketFactory _kAndroidConsoleSocketFactory =
    (String host, int port) => Socket.connect(host, port);
...
AndroidConsoleSocketFactory get androidConsoleSocketFactory =>
    context.get<AndroidConsoleSocketFactory>() ?? _kAndroidConsoleSocketFactory;
