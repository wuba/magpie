    ...
    if (_validators == null) {
      _validators = <DoctorValidator>[
        ...
        if (iosWorkflow.appliesToHostPlatform ||
          ...
          GroupedValidator(
              <DoctorValidator>[xcodeValidator, cocoapodsValidator]),
        if (webWorkflow.appliesToHostPlatform) const WebValidator(),
...
class ValidationMessage {
  ...
  bool operator ==(Object other) {
    ...
    return typedOther.message == message && typedOther.type == type;
  }
