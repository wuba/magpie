...
abstract class ProcessUtils {
  ...
  static ProcessUtils get instance => context.get<ProcessUtils>()==null?ProcessUtils():context.get<ProcessUtils>();
...
//                 '$runResult');
      print('Process "${cmd[0]}" timed out. $timeoutRetries attempts left:\n'
          '$runResult');
    }
  ...
  void _traceCommand(List<String> args, { String workingDirectory }) {
    ...
    if (workingDirectory == null) {
      ...
      print('executing: $argsText');
    } else {
      print('executing: [$workingDirectory${fs.path.separator}] $argsText');
