...
OperatingSystemUtils get os => context.get<OperatingSystemUtils>() ?? OperatingSystemUtils();
...
class _PosixUtils extends OperatingSystemUtils {
  ...
  void chmod(FileSystemEntity entity, String mode) {
    try {
      final ProcessResult result = processManager.runSync(<String>['chmod', '-R',mode, entity.path]);
